...
・詳しい説明は以下のURLにあります。
　https://github.com/TammyBee/RimWorldMod_DetailPortraits/wiki
・紹介動画もあります。
　https://www.nicovideo.jp/watch/sm35984080
...
・縦方向と横方向の拡大率を個別に変更できるようにしました。
・レイヤーを有効化/無効化できるようにしました。
